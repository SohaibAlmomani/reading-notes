...
![](./git%20practice/Part-1.png)

## Part 2:

![](./git%20practice/Part-2.png)
...
- ### 4.2 Juggling Commits :
  - 1. ) _For the solution, order the commits as C3, C2. You may need to omit or pick commits._

  - 2. ) _For the solution, order the commits as C2'', C3'. You may need to omit or pick commits._
```
